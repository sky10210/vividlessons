...
const VIVID_MODULES = [
  {
    id: "pfm-grocery-shopping-unit-price",
    title: "Grocery Shopping Without Going Broke",
    displayType: "Interactive Lesson",
    moduleSize: "premium",
    categories: ["personal-finance"],
    courseLabels: ["Personal Finance"],
    homepage: false,
    homepageOrder: null,
    dateAdded: "2026-09-06",
    homepageLabel: "New Module",
    topic: "Grocery Shopping, Meal Planning, and Unit Price",
    productType: "Interactive Module",
    description: "Students plan complete meals on a $75 budget, compare stores and brands, reduce food waste, and master unit price per ounce, pound, item, and serving.",
    questionCount: 25,
    previewQuestionCount: 0,
    estimatedMinutes: "25–35",
    types: ["Scenario-Based", "Matching", "Calculator"],
    tags: ["Grocery Budget", "Meal Planning", "Unit Price", "Store Brands", "Spending Decisions"],
    previewUrl: "modules/pfm-grocery-shopping-unit-price.html",
    fullModuleUrl: "modules/pfm-grocery-shopping-unit-price.html",
    teacherGuideUrl: "",
    launchUrl: "modules/pfm-grocery-shopping-unit-price.html",
    shopifyUrl: "",
    price: "",
    priceLabel: "class module",
    reflectionRequired: true,
    certificateIncluded: true,
    completionTracking: true,
    autoScored: true,
    featured: true,
    order: {"personal-finance": 4,"all": 4},
    sections: ["Meal planning", "Building meals around protein", "Food waste", "Name brand vs. store brand", "Store cart comparison", "Unit price calculations", "Reflection and certificate"]
  },
  {
